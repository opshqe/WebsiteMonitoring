...
public class WebsiteMonitor {
    ...
    public void checkAllWebsites(SubscriptionController controller) {
        for (Website website : websites) {
            checkSingleWebsite(website, controller);
        }
    }

    public void checkSingleWebsite(Website website, SubscriptionController controller) {
        ...
        if (changed) {
            ...
            controller.notifySubscribers(website);
        } else {
